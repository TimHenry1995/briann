...
from src.briann.network import core as bnc

# Load Configuration
from experiments.sinusoids import model_loader
training_configuration = model_loader.training_configuration
...
state_dict_path = bpufm.map_path_to_os(path=os.path.join("experiments/vggish/example briann state_dict.pth"))
