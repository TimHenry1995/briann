...
for _i, _dimensionality in enumerate([1,7,4,2,1,3]):
    _time_frame_accumulators[_i] = bnc.TimeFrameAccumulator(initial_time_frame=bnc.TimeFrame(state=torch.zeros([_batch_size,_dimensionality]), time_point=0.0), decay_rate=0.9) 
